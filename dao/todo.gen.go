...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.Todo = field.NewString(tableName, "todo")
	_todo.IsDone = field.NewBool(tableName, "is_done")
...
func (t *todo) updateTableName(table string) *todo {
	...
	t.Todo = field.NewString(table, "todo")
	t.IsDone = field.NewBool(table, "is_done")
...
func (t *todo) fillFieldMap() {
	...
	t.fieldMap["todo"] = t.Todo
	t.fieldMap["is_done"] = t.IsDone
}
